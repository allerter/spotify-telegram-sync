...
Forked from the pycaw package.The only difference is that
I implemented getting the State of the session which was
not implementd before (lines 239 and 240)
"""
